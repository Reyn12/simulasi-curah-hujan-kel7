...
const driver = window.driver.js.driver;
    ...
    const driverObj = driver({
        showProgress: true,
        steps: [
            { element: '#tour-example', popover: { title: 'WELCOME TO OUR PROGRAM || SIMULASI INTENSITAS CURAH HUJAN', description: 'Berikut ada TOUR SINGKAT mengenai cara menggunakan program SIMULASI CURAH HUJAN', side: "left", align: 'start' } },
            { element: '.hintBanyakInput', popover: { title: 'Masukkan Banyaknya Data Yang Akan Di input', description: 'Contoh: 50 Data, 20 Data, Maksimal 100 Data', side: "bottom", align: 'start' } },
            { element: '.hintCurahHujanBulanan', popover: { title: 'Masukkan Data CURAH HUJAN BULANAN sebanyak N Data', description: 'Note: Klik tombol Gunakan Data Default untuk mempersingkat waktu input data (Dari Soal)', side: "bottom", align: 'start' } },
            { element: '.hintLamaHujanBulanan', popover: { title: 'Masukkan Data CURAH LAMA BULANAN sebanyak N Data', description: 'Klik tombol Gunakan Data Default untuk mempersingkat waktu input data (Dari Soal)', side: "left", align: 'start' } },
            { element: '.hintInputVarRNG', popover: { title: 'Masukkan Variabel RNG Yang dibutuhkan', description: 'Bisa pilih LCG atau Multiplicative sesuai keinginan, dan Masukkan Value nya', side: "right", align: 'start' } },
            { element: '.hintBanyakSimulasi', popover: { title: 'Masukkan Banyaknya Simulasi', description: 'Contoh: 50 Simulasi, maka program akan menampilkan sebanyak 50 kali simulasi', side: "right", align: 'start' } },
            { element: '.hintBuatSimulasi', popover: { title: 'Button Buat Simulasi', description: 'Klik untuk menampilkan hasil data simulasi dalam bentk Chart dan Tabel', side: "right", align: 'start' } },
            { element: '.hintHasilTabelSimulasi', popover: { title: 'Tabel Hasil Simulasi', description: 'Program akan menampilkan hasil tabel Simulasi', side: "right", align: 'start' } },
            { popover: { title: 'Enjoy The Program...!!!', description: 'Build BY : Muhammad Renaldi Maulana - (10122002) || Dawla Izza Al-Din Noor - (10122034) || Muhamad Raihan Nurzamzam - (10122037)' } }
        ]
    });
